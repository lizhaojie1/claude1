...
from com_admin.form.admin_boos_form import AdminBoosModelForm
from com_admin.form.admin_change_form import AdminChangeModelForm
from com_admin.form.admin_com_type_form import AdminComTypeModelForm
from com_admin.form.admin_comment_form import AdminCommentModelForm
from com_admin.form.admin_user_form import AdminUserModelForm
...
def admin_home(request):
    ...
    if q:
        ...
        # print(user_query, '--------')
        page_html = page_object.page_html()
    return render(request, 'com_admin/home.html', locals())
...
def com_home(request):
    ...
    if q:
        ...
        # print(user_query, '--------')
        page_html = page_object.page_html()
    return render(request, 'com/com_home.html', locals())
...
def com_add(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'com/add_com.html', locals())
    form_error = '请遵守规则'
