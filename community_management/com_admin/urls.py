...
urlpatterns = [
    ...
    # 社团活动
    path('com_active_home/', views.com_active_home, name='com_active_home'),
    path('com_add_active/', views.com_add_active, name='com_add_active'),
    path('com_edit_active/', views.com_edit_active, name='com_edit_active'),
    path('com_delete_active/', views.com_delete_active, name='com_delete_active'),
    # 申请记录
